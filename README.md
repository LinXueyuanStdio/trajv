...
[![VS Marketplace](https://badgen.net/vs-marketplace/v/LinXueyuanStdio.trajv-jsonl-viewer)](https://marketplace.visualstudio.com/items?itemName=LinXueyuanStdio.trajv-jsonl-viewer)
[![VS Marketplace Installs](https://badgen.net/vs-marketplace/i/LinXueyuanStdio.trajv-jsonl-viewer)](https://marketplace.visualstudio.com/items?itemName=LinXueyuanStdio.trajv-jsonl-viewer)
[![Open VSX](https://img.shields.io/open-vsx/v/LinXueyuanStdio/trajv-jsonl-viewer)](https://open-vsx.org/extension/LinXueyuanStdio/trajv-jsonl-viewer)
[![Open VSX Downloads](https://img.shields.io/open-vsx/dt/LinXueyuanStdio/trajv-jsonl-viewer)](https://open-vsx.org/extension/LinXueyuanStdio/trajv-jsonl-viewer)
